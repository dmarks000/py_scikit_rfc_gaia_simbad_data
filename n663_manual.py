...
# with open(input_table_base,'r',newline='') as csvfile:
...
#                ID.append(row[0])
#                try:
#                     ra.append(float(row[8]))  # The downside of csv format is
...
#                     dec.append(-999.)
#                try:
#                     plx.append(float(row[12]))
#                except:
#                     plx.append(-999.)
#                try:
#                     eplx.append(float(row[13]))
#                except:
#                     eplx.append(-999.)
#                try:
#                     pmra.append(float(row[14]))
#                except:
#                     pmra.append(-999.)
#                try:
#                     epmra.append(float(row[15]))
#                except:
#                     epmra.append(-999.)
#                try:
#                     pmdec.append(float(row[16]))
#                except:
#                     pmdec.append(-999.)
#                try:
#                     epmdec.append(float(row[17]))
#                except:
#                     epmdec.append(-999.)
#                try:
#                     g.append(float(row[18]))
#                except:
#                     g.append(-999.)
#                try:
#                     bprp.append(float(row[20]))
#                except:
#                     bprp.append(-999.)
...
import csv
with open(cluster + '_stragglers_table.csv','w') as f:
     write = csv.writer(f)
